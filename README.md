...
- **총 방문자**: **10,772명**에게 실시간 정보 제공
- **사용자 참여도**: 방문자당 평균 **13.5페이지** 조회
- **사용자 경험**: **16% 이탈률**로 높은 사용자 경험 입증
- **모바일 최적화**: **93% 모바일 사용률**로 현장 활용도 극대화

#### 💡 기술적 성과

- **성능 최적화**: RSC와 ISR로 초기 로딩 시간 단축 및 실시간 유저 폭증으로 인한
  서버 부하 개선
- **모바일 UX 최적화**: 320px~500px 반응형 디자인으로 현장 사용성 강화
- **정보 전달 효과성**: 부스 정보 페이지 70% 방문률로 핵심 기능 활용도 입증

#### 🎯 비즈니스 임팩트

- **연세대 재학생 약 25% 커버리지**: 전체 재학생 대비 높은 서비스 활용률
- **축제 운영 효율성 향상**: 실시간 부스/공연 정보 제공으로 현장 혼잡도 감소
- **사용자 만족도**: 낮은 이탈률과 높은 재방문률 달성 및 다수의 긍정적 피드백
  수집
